...
async function main() {
    ...
    // Call getCarbonCreditPrice function
    const carbonCreditPrice = await contract.getCarbonCreditPrice();
    console.log("Carbon Credit Price:", ethers.formatEther(carbonCreditPrice));
    }
